...
<a
  ...
  class="header-cart-link off-canvas-toggle nav-top-link <?php echo get_flatsome_icon_class($icon_style, 'small'); ?>"
  <?php if(!$disable_mini_cart) echo 'data-open="#cart-popup"' ; ?>
  data-class="off-canvas-cart"
  title="<?php _e('Cart', 'woocommerce'); ?>"
  data-pos="right">
