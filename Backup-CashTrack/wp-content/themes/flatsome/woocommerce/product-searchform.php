...
<form role="search" method="get" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
		<div class="flex-row relative">
			...
			<?php
				...
				$selected_category = ( isset( $_REQUEST['product_cat'] ) ) ? $_REQUEST['product_cat'] : 'needs';

				echo '<select class="search_categories resize-select mb-0" name="product_cat" style="display:none;">';
